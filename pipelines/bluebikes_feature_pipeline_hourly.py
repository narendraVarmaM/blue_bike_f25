...
# Step 2: Define the data fetching range (using 2-month shift)
fetch_data_to = current_date
fetch_data_from = current_date - timedelta(days=28)
logger.info(f"Fetching data from {fetch_data_from} to {fetch_data_to}")

# Step 3: Fetch raw data with 2-month historical shift
logger.info("Fetching raw Blue Bikes data...")
...
logger.info("Blue Bikes feature pipeline completed successfully!")
